                    ...
                    ElevatedButton(
                        ...
                        onPressed: () {
                          if (formkey.currentState!.validate()) {
                            ...
                            widget.data.Ecurrent =
                                int.parse(EcurContoller.text);
                            widget.data.Eprevious =
                                int.parse(EpreContoller.text);
                            widget.data.Eunit = int.parse(EunitContoller.text);
                            widget.data.Wcurrent =
                                int.parse(WcurContoller.text);
                            widget.data.Wprevious =
                                int.parse(WpreContoller.text);
